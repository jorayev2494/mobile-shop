...
{
    public function link(string $email, AppGuardType $guard = AppGuardType::CLIENT): void
    {
    ...
    public function restore(RestorePasswordData $data, AppGuardType $guard = AppGuardType::CLIENT): void
    {
        ...
        $foundCode->codeAble->resetDevices();
        $foundCode->delete();
    }
}
