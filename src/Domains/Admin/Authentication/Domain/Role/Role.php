...
use Project\Domains\Admin\Authentication\Infrastructure\Doctrine\Role\Types\ValueType;
...
class Role extends AggregateRoot
{
    ...
    #[ORM\JoinTable(name: 'auth_roles_permissions')]
    ...
    public static function create(Value $value, array $permissions = [], bool $isActive = true): self
    {
