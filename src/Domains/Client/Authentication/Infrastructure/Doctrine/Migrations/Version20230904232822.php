 ...
 */
final class Version20230904232822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auth_device (uuid VARCHAR(255) NOT NULL, refresh_token VARCHAR(255) NOT NULL, device_id VARCHAR(255) NOT NULL, os VARCHAR(255) DEFAULT NULL, os_version VARCHAR(255) DEFAULT NULL, app_version VARCHAR(255) DEFAULT NULL, ip_address VARCHAR(255) DEFAULT NULL, author_uuid VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(uuid))');
        ...
        $this->addSql('CREATE TABLE auth_members (uuid VARCHAR(255) NOT NULL, device_uuid VARCHAR(255) NOT NULL, code_id INT DEFAULT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(uuid))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B84F20CE7927C74 ON auth_members (email)');
        $this->addSql('CREATE INDEX IDX_B84F20C5846859C ON auth_members (device_uuid)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B84F20C27DAFE17 ON auth_members (code_id)');
        ...
        $this->addSql('ALTER TABLE auth_members ADD CONSTRAINT FK_B84F20C5846859C FOREIGN KEY (device_uuid) REFERENCES auth_device (uuid) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE auth_members ADD CONSTRAINT FK_B84F20C27DAFE17 FOREIGN KEY (code_id) REFERENCES auth_codes (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE auth_members DROP CONSTRAINT FK_B84F20C5846859C');
        $this->addSql('ALTER TABLE auth_members DROP CONSTRAINT FK_B84F20C27DAFE17');
