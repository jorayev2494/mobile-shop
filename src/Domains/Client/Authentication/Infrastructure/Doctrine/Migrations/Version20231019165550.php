 ...
 */
final class Version20231019165550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auth_codes (id INT NOT NULL, author_uuid VARCHAR(255) DEFAULT NULL, value INT NOT NULL, expired_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE order_cards (uuid VARCHAR(255) NOT NULL, client_uuid VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, holderName VARCHAR(255) NOT NULL, number VARCHAR(255) NOT NULL, cvv INT NOT NULL, expirationDate VARCHAR(255) NOT NULL, PRIMARY KEY(uuid))');
        ...
        $this->addSql('CREATE TABLE order_currencies (uuid VARCHAR(255) NOT NULL, value VARCHAR(255) NOT NULL, is_active BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(uuid))');
        $this->addSql('COMMENT ON COLUMN order_currencies.created_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN order_currencies.updated_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE order_orders (uuid VARCHAR(255) NOT NULL, author_uuid VARCHAR(255) NOT NULL, card_uuid VARCHAR(255) DEFAULT NULL, address_uuid VARCHAR(255) DEFAULT NULL, currency_uuid VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, note VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, meta_quantity INT NOT NULL, meta_sum NUMERIC(7, 2) NOT NULL, PRIMARY KEY(uuid))');
        ...
        $this->addSql('ALTER TABLE order_orders ADD CONSTRAINT FK_26A0ED3B5BC813D2 FOREIGN KEY (currency_uuid) REFERENCES order_currencies (uuid) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE order_currencies');
