...
namespace Project\Domains\Client\Delivery\Infrastructure\Doctrine\Product\Types;

use Doctrine\DBAL\Types\Type;
use Project\Domains\Client\Delivery\Domain\Product\ValueObjects\CategoryUuid;

final class CategoryUuidType extends Type
{
    public const NAME = 'client_domain_delivery_product_category_uuid';
