...
{
    public const NAME = 'client_domain_delivery_address_author_uuid';
    ...
    public function convertToPHPValue($value, \Doctrine\DBAL\Platforms\AbstractPlatform $platform): AuthorUuid
    {
