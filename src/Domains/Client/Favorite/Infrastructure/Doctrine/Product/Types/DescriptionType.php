...
{
    public const NAME = 'client_domain_favorite_description';
    ...
    public function convertToPHPValue($value, \Doctrine\DBAL\Platforms\AbstractPlatform $platform): ProductDescription
    {
        return ProductDescription::fromValue($value);
    }
