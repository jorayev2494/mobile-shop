...
{
    public const NAME = 'client_domain_address_full_name';
    ...
    public function convertToPHPValue($value, \Doctrine\DBAL\Platforms\AbstractPlatform $platform): AddressFullName
    {
        return AddressFullName::fromValue($value);
    }
