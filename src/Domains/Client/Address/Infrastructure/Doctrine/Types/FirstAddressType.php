...
{
    public const NAME = 'client_domain_address_first_address';
    ...
    /**
     * @param AddressFirstAddress $value
    ...
    public function convertToPHPValue($value, \Doctrine\DBAL\Platforms\AbstractPlatform $platform): AddressFirstAddress
    {
        return AddressFirstAddress::fromValue($value);
    }
