...
{
    public const NAME = 'client_domain_address_district';
    ...
    public function convertToPHPValue($value, \Doctrine\DBAL\Platforms\AbstractPlatform $platform): AddressDistrict
    {
        return AddressDistrict::fromValue($value);
    }
